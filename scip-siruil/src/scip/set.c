...
// start mbp28: deprecate minorthoroot and minortho
...
#define SCIP_DEFAULT_SEPA_MAXPARALLROOT      0.1   /**< at root, maxparall for cuts, mbp28 */
#define SCIP_DEFAULT_SEPA_GOODMAXPARALLROOT  0.5   /**< at root, maxparall for good cuts, mbp28 */
#define SCIP_DEFAULT_SEPA_MAXPARALL          0.1   /**< maxparall for good cuts, mbp28 */
#define SCIP_DEFAULT_SEPA_GOODMAXPARALL      0.5   /**<  maxparall for good cuts, mbp28 */

// end mbp28
#define SCIP_DEFAULT_SEPA_GOODSCOREFAC     0.90 /**< threshold for score of cut relative to best score to be considered good, so that less strict filtering is applied */
#define SCIP_DEFAULT_SEPA_BADSCOREFAC      0.00 /**< threshold for score of cut relative to best score to be discarded */
...
#define SCIP_DEFAULT_SEPA_LOOKAHEADFAC      0.0 /**< factor to scale lookahead score of cut in score calculation, added by mbp28 */
...
/* Opt Separation, added by mbp28 */
#define SCIP_DEFAULT_OPTSEPA_DUPLICATING FALSE /**< in opt separation, should duplicates be added to the pool? only set to TRUE for debugging */
#define SCIP_DEFAULT_OPTSEPA_CLIQUE FALSE /**< switch clique cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_CMIR FALSE /**< switch cmir cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_DISJUNCTIVE FALSE /**< switch disjunctive cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_FLOWCOVER FALSE /**< switch flowcover cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_GOMORY FALSE /**< switch gomory cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_IMPLIEDBOUNDS FALSE /**< switch impliedbounds cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_MCF FALSE /**< switch mcf cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_ODDCYCLE FALSE /**< switch oddcycle cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_STRONGCG FALSE /**< switch strongcg cuts on/ off in optseparation */
#define SCIP_DEFAULT_OPTSEPA_ZEROHALF FALSE /**< switch zerohalf cuts on/ off in optseparation */
   ...
   )
{
   ...
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         ...
         NULL, NULL) );
   // start mbp28: deprecate minorthoroot, minortho
   // SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
   //       "separating/minortho",
   ...
   //       NULL, NULL) );
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "separating/goodmaxparallroot",
         "max parallelism for good cuts to enter the LP in the root node",
         &(*set)->sepa_goodmaxparallroot, FALSE, SCIP_DEFAULT_SEPA_GOODMAXPARALLROOT, 0.0, 1.0,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "separating/maxparallroot",
         "max parallelism for cuts to enter the LP in the root node",
         &(*set)->sepa_maxparallroot, FALSE, SCIP_DEFAULT_SEPA_MAXPARALLROOT, 0.0, 1.0,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "separating/goodmaxparall",
         "max parallelism for good cuts to enter the LP",
         &(*set)->sepa_goodmaxparall, FALSE, SCIP_DEFAULT_SEPA_GOODMAXPARALL, 0.0, 1.0,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "separating/maxparall",
         "max parallelism for cuts to enter the LP",
         &(*set)->sepa_maxparall, FALSE, SCIP_DEFAULT_SEPA_MAXPARALL, 0.0, 1.0,
         NULL, NULL) );
   // end mbp28
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
   ...
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         ...
         NULL, NULL) );
   // added by mbp28, for lookahead.
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "separating/lookaheadfac",
         "factor to scale efficacy of cut in score calculation",
         &(*set)->sepa_lookaheadfac, TRUE, SCIP_DEFAULT_SEPA_LOOKAHEADFAC, 0.0, SCIP_INVALID/10.0,
         NULL, NULL) );
   // added by mbp28, for more control over cut selection (previously hardcoded)
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "separating/goodscorefac",
         "threshold for score of cut relative to best score to be considered good, so that less strict filtering is applied",
         &(*set)->sepa_goodscorefac, TRUE, SCIP_DEFAULT_SEPA_GOODSCOREFAC, 0.0, 1.0, NULL, NULL) );
   // added by mbp28, for more control over cut selection (previously hardcoded)
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "separating/badscorefac",
         "threshold for score of cut relative to best score to be discarded",
         &(*set)->sepa_badscorefac, TRUE, SCIP_DEFAULT_SEPA_BADSCOREFAC, 0.0, 1.0, NULL, NULL) );
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
   ...
   /* optseparation parameters, added by mbp28  */
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/duplicating",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_duplicating, FALSE, SCIP_DEFAULT_OPTSEPA_DUPLICATING,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/clique",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_clique, FALSE, SCIP_DEFAULT_OPTSEPA_CLIQUE,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/cmir",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_cmir, FALSE, SCIP_DEFAULT_OPTSEPA_CMIR,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/disjunctive",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_disjunctive, FALSE, SCIP_DEFAULT_OPTSEPA_DISJUNCTIVE,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/flowcover",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_flowcover, FALSE, SCIP_DEFAULT_OPTSEPA_FLOWCOVER,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/gomory",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_gomory, FALSE, SCIP_DEFAULT_OPTSEPA_GOMORY,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/impliedbounds",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_impliedbounds, FALSE, SCIP_DEFAULT_OPTSEPA_IMPLIEDBOUNDS,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/mcf",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_mcf, FALSE, SCIP_DEFAULT_OPTSEPA_MCF,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/oddcycle",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_oddcycle, FALSE, SCIP_DEFAULT_OPTSEPA_ODDCYCLE,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/strongcg",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_strongcg, FALSE, SCIP_DEFAULT_OPTSEPA_STRONGCG,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "optseparating/zerohalf",
         "in opt separation, should duplicates be added to the pool? only set to TRUE for debug",
         &(*set)->optsepa_zerohalf, FALSE, SCIP_DEFAULT_OPTSEPA_ZEROHALF,
         NULL, NULL) );

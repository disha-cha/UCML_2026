...
struct SCIP_Set
{
   ...
   SCIP_Real             sepa_maxparallroot;      /**< at root, maxparall for cuts, mbp28 */
   SCIP_Real             sepa_goodmaxparallroot;  /**< at root, maxparall for good cuts, mbp28 */
   SCIP_Real             sepa_maxparall;          /**< maxparall for cuts, mbp28 */
   SCIP_Real             sepa_goodmaxparall;      /**< maxparall for good cuts, mbp28 */
   // end mbp28
   SCIP_Real             sepa_efficacyfac;   /**< factor to scale efficacy of cut in score calc. */
   SCIP_Real             sepa_lookaheadfac;   /**< factor to scale lookahead score of cut in score calc., added by mbp28 */
   SCIP_Real             sepa_goodscorefac;   /**< threshold for score of cut relative to best score to be considered good, so that less strict filtering is applied. added by mbp28 */
   SCIP_Real             sepa_badscorefac;   /**< threshold for score of cut relative to best score to be discarded, added by mbp28 */
   ...
   SCIP_Bool             optsepa_duplicating;
   SCIP_Bool             optsepa_clique;
   SCIP_Bool             optsepa_cmir; // aggregation
   SCIP_Bool             optsepa_disjunctive;
   SCIP_Bool             optsepa_flowcover; // aggregation
   SCIP_Bool             optsepa_gomory;
   SCIP_Bool             optsepa_impliedbounds;
   SCIP_Bool             optsepa_mcf;
   SCIP_Bool             optsepa_oddcycle;
   SCIP_Bool             optsepa_strongcg;
   SCIP_Bool             optsepa_zerohalf;

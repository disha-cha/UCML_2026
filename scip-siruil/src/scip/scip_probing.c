...
/* mbp28 */
SCIP_RETCODE SCIPstartLookaheadProbing(
   SCIP*                 scip                /**< SCIP data structure */
   )
   {
     ...
     /* actually start probing */
     ret_code = SCIPstartProbing(scip);
...
SCIP_RETCODE SCIPendLookaheadProbing(
   SCIP*                 scip                /**< SCIP data structure */
   )
{
   SCIP_RETCODE ret_code;

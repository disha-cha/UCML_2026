   ...
   )
{
   ...
   SCIP_CALL( SCIPsepastoreCreate(&scip->optsepastore, scip->mem->probmem, scip->set) ); /* added by mbp28, settings ignored */
   ...
   SCIP_CALL( SCIPcutpoolCreate(&scip->optcutpool, scip->mem->probmem, scip->set, -1, FALSE) ); /* added by mbp28, settings ignored */

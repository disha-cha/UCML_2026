...
SCIP_RETCODE SCIPselectCuts(
   ...
   SCIP_Real             lookaheadweight,    /**< weight of lookahead score in score calculation, added by mbp28 */
   int                   ncuts,              /**< number of cuts in given array */
   ...
   *nselectedcuts = 0;
   ...
   if( sol != NULL && dircutoffdistweight > 0.0 )
   {
      for( i = 0; i < ncuts; ++i )
      {
         ...
         SCIP_Real efficacy;
         SCIP_Real lookahead; // added by mbp28
         ...
         // added by mbp28
         lookahead = lookaheadweight != 0.0 ? lookaheadweight * SCIPgetCutLookaheadScore(scip, cuts[i]) : 0.0;
         ...
         scores[i] += objparallelism + intsupport + efficacy + lookahead; // added by mbp28

...
/* added by mbp28, simply startDive, but with Lookahead timer. */
SCIP_RETCODE SCIPstartLookaheadDive(
   SCIP*                 scip                /**< SCIP data structure */
   )
{
...
/* added by mbp28, simply endDive, but with Lookahead timer. */
SCIP_RETCODE SCIPendLookaheadDive(
   SCIP*                 scip                /**< SCIP data structure */
   )
{
   assert(scip != NULL);

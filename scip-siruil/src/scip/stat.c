   ...
   )
{
   ...
   SCIP_CALL( SCIPclockCreate(&(*stat)->lookaheadtime, SCIP_CLOCKTYPE_DEFAULT) ); // added by mbp28
   ...
   )
{
   ...
   SCIPclockFree(&(*stat)->lookaheadtime);  // added by mbp28
   ...
   )
{
   ...
   SCIPclockReset(stat->lookaheadtime);  // added by mbp28
   ...
   )
{
   ...
   SCIPclockEnableOrDisable(stat->lookaheadtime, enable); // added by mbp28
}

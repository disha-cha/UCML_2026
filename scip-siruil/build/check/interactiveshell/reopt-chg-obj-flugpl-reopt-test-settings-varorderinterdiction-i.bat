...
set load /home/disha/UCML_2026/scip-siruil/check/coverage/settings/reopt-test-settings-varorderinterdiction-i.set
optimize
read /home/disha/UCML_2026/scip-siruil/check/instances/MIP/flugpl_reopt/flugpl_1.diff
optimize
validatesolve -75 -75
read /home/disha/UCML_2026/scip-siruil/check/instances/MIP/flugpl_reopt/flugpl_2.diff
optimize

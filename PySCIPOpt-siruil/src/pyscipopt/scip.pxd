...
cdef extern from "scip/scip.h":
    ...
    ctypedef struct SCIP_STAT:
      SCIP_Real primaldualintegral # added by mbp28
      pass
    ...
    ctypedef struct SCIP_LP:
        SCIP_Real objsqrnorm  # added by gizarp
    ...
    ctypedef struct SCIP_CONFLICT:
      pass

    ctypedef struct SCIP_CLIQUETABLE:
      pass

    ctypedef struct SCIP_PRICESTORE:
      pass

    ctypedef struct SCIP_SEPASTORE:
      pass

    ctypedef struct SCIP_CONFLICTSTORE:
      pass
    ...
    SCIP_Real SCIPgetLookaheadTime(SCIP* scip) # added by mbp28
    ...
    SCIP_RETCODE SCIPstartLookaheadDive(SCIP* scip) # mbpaulus
    ...
    SCIP_RETCODE SCIPendLookaheadDive(SCIP* scip) # mbpaulus

    # Probing methods
    SCIP_RETCODE SCIPstartProbing(SCIP* scip)
    SCIP_RETCODE SCIPstartLookaheadProbing(SCIP* scip)
    ...
    SCIP_RETCODE SCIPendLookaheadProbing(SCIP* scip)
    ...
    SCIP_Real SCIPgetCutViolation(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutRelViolation(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutObjParallelism(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutExpImprov(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutSupportScore(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutIntSupport(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutLookaheadScore(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutLookaheadLPObjval(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutDefaultScoreWithoutDirectedCutoff(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutDefaultScore(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutSCIPScore(SCIP* scip, SCIP_ROW* cut) # added by mbp28
    SCIP_Real SCIPgetCutAdjustedDirectedCutoffDistance(SCIP* scip, SCIP_ROW* cut, SCIP_SOL* sol) # added by mbp28
    SCIP_Real SCIPgetCutDirectedCutoffDistance(SCIP* scip, SCIP_ROW* cut, SCIP_SOL* sol) # added by mbp28
    SCIP_Bool SCIPisCutEfficacious(SCIP* scip, SCIP_SOL* sol, SCIP_ROW* cut)
    int SCIPgetNCuts(SCIP* scip)
    int SCIPgetNPoolCuts(SCIP* scip) # added by mbp28
    SCIP_CUT** SCIPgetPoolCuts(SCIP* scip) # added by mbp28
    SCIP_ROW** SCIPgetCuts(SCIP* scip)	# added by mbp28
    int SCIPgetNCutsApplied(SCIP* scip)
    int SCIPgetNSepaRounds(SCIP* scip)  # added by gizarp
    int SCIPgetNCutsFound(SCIP* scip)  # added by gizarp
    int SCIPgetNCutsFoundRound(SCIP* scip)  # added by gizarp
    SCIP_RETCODE SCIPseparateSol(SCIP* scip, SCIP_SOL* sol, SCIP_Bool pretendroot, SCIP_Bool allowlocal, SCIP_Bool onlydelayed, SCIP_Bool* delayed, SCIP_Bool* cutoff)
    SCIP_ROW** SCIPgetOptCuts(SCIP* scip) # added by mbp28
    int SCIPgetNOptCuts(SCIP* scip) # added by mbp28
    SCIP_RETCODE SCIPclearOptCuts(SCIP* scip) # added by mbp28
    SCIP_RETCODE SCIPremoveInefficaciousOptCuts(SCIP* scip) # added by mbp28
    ...
    SCIP_RETCODE SCIPaddOptRow(SCIP* scip, SCIP_ROW* row, SCIP_Bool* infeasible) # added by mbp28
    ...
    SCIP_Real SCIPgetLowerbound(SCIP* scip) # mbp28
...
cdef extern from "scip/pub_lp.h":
    ...
    int SCIProwGetRank(SCIP_ROW* row)  # added by gizarp
    ...
    SCIP_Bool SCIProwIsInGlobalCutpool(SCIP_ROW* row)  # added by gizarp
    # some more methods
    SCIP_CONS* SCIProwGetOriginCons(SCIP_ROW* row)  # added by gizarp
    SCIP_Bool SCIProwIsInLP(SCIP_ROW* row)  # added by gizarp
    SCIP_COL** SCIProwGetCols(SCIP_ROW* row)
    SCIP_Real* SCIProwGetVals(SCIP_ROW* row)
    SCIP_Real SCIPgetRowObjParallelism(SCIP* scip, SCIP_ROW* row)  # added by gizarp
    int SCIPgetRowNumIntCols(SCIP* scip, SCIP_ROW* row)  # added by gizarp
    # int SCIProwGetMinidx(SCIP_ROW* row)
    SCIP_Real SCIPgetRowLPFeasibility(SCIP* scip, SCIP_ROW* row)  # added by gizarp
    SCIP_Real SCIPgetRowSolActivity(SCIP* scip, SCIP_ROW* row, SCIP_SOL* sol)  # added by gizarp
    SCIP_Real SCIPgetRowSolFeasibility(SCIP* scip, SCIP_ROW* row, SCIP_SOL* sol)  # added by gizarp
...
# added by mbp28:
cdef extern from "scip/pub_sepa.h":
...
# # added by mbp28
cdef extern from "scip/scip_lp.h":
    ...
    SCIP_Real SCIPgetRowSolActivity(SCIP* scip, SCIP_ROW* row, SCIP_SOL*)
    SCIP_Real SCIPgetRowSolFeasibility(SCIP* scip, SCIP_ROW* row, SCIP_SOL*)
...
# added by mbp28
cdef extern from "scip/sepa_aggregation.h":
    SCIP_RETCODE SCIPoptsepaAggregation(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_clique.h":
    SCIP_RETCODE SCIPoptsepaClique(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_disjunctive.h":
    SCIP_RETCODE SCIPoptsepaDisjunctive(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_gomory.h":
    SCIP_RETCODE SCIPoptsepaGomory(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_impliedbounds.h":
    SCIP_RETCODE SCIPoptsepaImpliedbounds(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_mcf.h":
    SCIP_RETCODE SCIPoptsepaMcf(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_oddcycle.h":
    SCIP_RETCODE SCIPoptsepaOddcycle(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_strongcg.h":
    SCIP_RETCODE SCIPoptsepaStrongcg(SCIP* scip, SCIP_RESULT* result)

# added by mbp28
cdef extern from "scip/sepa_zerohalf.h":
    SCIP_RETCODE SCIPoptsepaZerohalf(SCIP* scip, SCIP_RESULT* result)

cdef extern from "scip/scip_cut.h":
    # added by mbp28
    SCIP_RETCODE SCIPaddOptPoolCut(SCIP* scip, SCIP_ROW* row) # added by mbp28
    SCIP_RETCODE SCIPdelOptPoolCut(SCIP* scip, SCIP_ROW* row)
    SCIP_CUT** SCIPgetOptPoolCuts(SCIP* scip)
    int SCIPgetNOptPoolCuts(SCIP* scip)
    SCIP_RETCODE SCIPclearOptPoolCuts(SCIP* scip)

cdef extern from "scip/pub_cutpool.h":
    int SCIPcutGetAge(SCIP_CUT* cut)
    SCIP_ROW* SCIPcutGetRow(SCIP_CUT* cut)

cdef extern from "scip/solve.h":
    SCIP_RETCODE resolveForcedCuts(BMS_BLKMEM *blkmem, SCIP_SET *set,
    SCIP_MESSAGEHDLR* messagehdlr, SCIP_STAT *stat, SCIP_MEM* mem,
    SCIP_PROB *transprob, SCIP_PROB *origprob, SCIP_PRIMAL* primal,
    SCIP_TREE *tree, SCIP_REOPT *reopt, SCIP_LP *lp, SCIP_PRICESTORE* pricestore,
    SCIP_SEPASTORE* sepastore, SCIP_CUTPOOL* cutpool, SCIP_CUTPOOL* delayedcutpool,
    SCIP_BRANCHCAND* branchcand,SCIP_CONFLICT* conflict, SCIP_CONFLICTSTORE* conflictstore,
    SCIP_EVENTFILTER *eventfilter, SCIP_EVENTQUEUE *eventqueue,
    SCIP_CLIQUETABLE *cliquetable, SCIP_Bool fullseparation,
    SCIP_Bool* propagateagain, SCIP_Bool* cutoff, SCIP_Bool* unbounded,
    SCIP_Bool* lperror, SCIP_Bool* pricingaborted)
    SCIP_RETCODE SCIPapplyOptCutsToLP(BMS_BLKMEM *blkmem, SCIP_SET *set,
    SCIP_MESSAGEHDLR* messagehdlr, SCIP_STAT *stat, SCIP_MEM* mem,
    SCIP_PROB *transprob, SCIP_PROB *origprob, SCIP_PRIMAL* primal,
    SCIP_TREE *tree, SCIP_REOPT *reopt, SCIP_LP *lp, SCIP_SEPASTORE* optsepastore,
    SCIP_BRANCHCAND* branchcand, SCIP_EVENTFILTER *eventfilter, SCIP_EVENTQUEUE *eventqueue,
    SCIP_CLIQUETABLE *cliquetable, SCIP_Bool* cutoff, SCIP_Bool* unbounded,
    SCIP_Bool* lperror)
...
cdef extern from "scip/sepastore.h":
    SCIP_RETCODE SCIPoverrideCutSelection(SCIP* scip, int* forcedcuts, int nforcedcuts)
